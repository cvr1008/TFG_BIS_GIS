...
\begin{tabular}{lll}
\hline
\textbf{Tipo de onda} & \textbf{Rango de frecuencia (Hz)} & \textbf{Interpretación general} \\
\hline
...
\hline
\end{tabular}
\caption{Bandas de frecuencia del EEG y su interpretación general. Elaboración propia a partir de [@ondas2019].}
