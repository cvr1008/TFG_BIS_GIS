...
temporales y métricas cuantitativas, se recogen en el Anexo G. En este
capítulo se resumen los resultados principales necesarios para valorar
...
procedentes de BIS VISTA sin información clínica ICCA asociada y sin
matriz \texttt{.f\_a} válida: en estos casos, el visualizador carga
igualmente la sesión BIS y fuerza la reconstrucción de la DSA a partir
de la señal cruda, incluyendo la reconstrucción bilateral cuando el
registro dispone de los dos hemisferios, tal y como se muestra en la
...
analizado y disponibilidad de información ICCA).
