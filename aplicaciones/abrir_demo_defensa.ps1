# Arranca la demo desde una carpeta copiada a un pendrive.
# Usa siempre la carpeta relativa ..\datos\pacientes, asi no importa la letra
# que Windows asigne al USB.
